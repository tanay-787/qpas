...
import { SidebarGroupContent, SidebarGroupLabel, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarMenuSub, SidebarMenuSubButton, SidebarMenuSubItem, SidebarProvider, SidebarTrigger } from "@/components/ui/sidebar"
    ...
    <Sidebar collapsible="icon" variant="floating">
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem key="waiting-lobby" onClick={() => setActiveKey('waiting-lobby')} className={activeKey === 'waiting-lobby' ? 'active' : ''}>
                <SidebarMenuButton 
              ...
              <SidebarMenuItem>
                <Collapsible className="group/collapsible">
                  <CollapsibleTrigger asChild>
                    <SidebarMenuButton 
                      isActive={activeKey === 'view-qp' || activeKey === 'create-qp' || activeKey === 'manage-qp'}>
              ...
              <SidebarMenuItem key="institution-members" onClick={() => setActiveKey('institution-members')} className={activeKey === 'institution-members' ? 'active' : ''}>
                <SidebarMenuButton 
