...
const BentoCard = ({
  ...
  <div
    ...
    <div
      ...
      <Icon
        className="h-12 w-12 origin-left transform-gpu text-primary-foreground dark:text-primary transition-all duration-300 ease-in-out group-hover:scale-75" />
      <h3 className="text-xl font-semibold text-primary-foreground dark:text-primary">
        {name}
      </h3>
