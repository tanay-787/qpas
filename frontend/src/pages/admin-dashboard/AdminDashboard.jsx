...
// sub-components
import WaitingLobbyTab from "@/pages/admin-dashboard/WaitingLobbyTab";
import MembersTab from "@/pages/admin-dashboard/ManageMembersTab";
import ApplicationFormTab from "@/pages/admin-dashboard/ApplicationFormTab";
import InstitutionProfileTab from "@/pages/admin-dashboard/InstitutionProfileTab";
